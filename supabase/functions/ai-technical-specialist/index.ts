    ...
    "work_items": [
      {
        ...
        "materials": [
          {
            "material_name": "точное название из номенклатуры материалов",
            "quantity": число_с_учетом_коэффициентов,
            "unit": "единица измерения",
            "calculation": "формула расчета (например: 176 м² * 0.2 м * 1.1 = 38.72 м³)"
          }
        ]
      }
    ],
...
- materials должен содержать ВСЕ материалы для этой услуги с:
  * точными названиями из номенклатуры материалов
  * рассчитанным количеством (с учетом коэффициентов уплотнения, запаса и т.д.)
  * формулой расчета
- Примеры расчетов:
  * Песок: площадь * толщину_слоя * коэффициент_уплотнения (176 м² * 0.2 м * 1.1 = 38.72 м³)
  * Щебень: площадь * толщину_слоя * коэффициент_уплотнения (176 м² * 0.15 м * 1.26 = 33.26 м³)
  * Асфальт: площадь * толщину_слоя * плотность (176 м² * 0.05 м * 2.5 = 22 т)
